...
// Real XAUUSD chart via TradingView's free Advanced Chart widget. Multi-timeframe
// (own buttons + native toolbar) with EMA/RSI/MACD preloaded; users can add any of
// TradingView's free indicators from the chart toolbar.
    ...
    <div>
      <div className="mb-3 flex flex-wrap gap-1 rounded-xl border border-base-border bg-base-panel p-1">
        {TF.map((tf) => (
          <button
            key={tf.code}
            onClick={() => setInterval_(tf.interval)}
