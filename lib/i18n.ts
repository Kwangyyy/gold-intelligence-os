...
const DICT: Record<string, Bilingual> = {
  ...
  navCommandCenter: { th: "ศูนย์บัญชาการ AI", en: "AI Command Center" },
  ...
  navPositionCalc:         { th: "Position Calculator",  en: "Position Calculator"    },
  ...
  navCommodityMatrix:      { th: "Commodity Matrix",     en: "Commodity Matrix"       },
  navYieldCurve:           { th: "Yield Curve & Rates",  en: "Yield Curve & Rates"    },
  navGeoRisk:              { th: "Geopolitical Risk",    en: "Geopolitical Risk"      },
  ...
  navTradeGrade:           { th: "Trade Grade",            en: "Trade Grade"            },
  navMarketBreadth:        { th: "Market Breadth",         en: "Market Breadth"         },
  navGoldBeta:             { th: "Gold Beta & Proxies",    en: "Gold Beta & Proxies"    },
  navRiskSignals:          { th: "Risk Signal Aggregator", en: "Risk Signal Aggregator" },
  navDivergenceScan:       { th: "Divergence Scanner",     en: "Divergence Scanner"     },
  navFlowTracker:          { th: "Multi-Asset Flow",       en: "Multi-Asset Flow"       },
  navNewsImpact:           { th: "News Impact Studies",    en: "News Impact Studies"    },
  navGoldCycle:            { th: "Gold Market Cycle",      en: "Gold Market Cycle"      },
  navLiquidityMap:         { th: "Liquidity Map",          en: "Liquidity Map"          },
  navSmartMoney:           { th: "Smart Money Flow",       en: "Smart Money Flow"       },
  navCarryTrade:           { th: "Carry Trade & Forward",  en: "Carry Trade & Forward"  },
  navVolatilityTerm:       { th: "Volatility Surface",     en: "Volatility Surface"     },
  navGoldCurrencies:       { th: "Gold in Currencies",       en: "Gold in Currencies"      },
  navVolumeProfile:        { th: "Volume Profile",           en: "Volume Profile"          },
  navGoldSP500:            { th: "Gold vs S&P 500",          en: "Gold vs S&P 500"         },
  navMinerRatio:           { th: "Gold Miner Ratios",       en: "Gold Miner Ratios"       },
  navGlobalYields:         { th: "Global Bond Yields",      en: "Global Bond Yields"      },
  navPositionDashboard:    { th: "Position Dashboard",      en: "Position Dashboard"      },
  navCopperGold:           { th: "Copper/Gold Ratio",       en: "Copper/Gold Ratio"       },
  navFairValue:            { th: "Gold Fair Value Model",   en: "Gold Fair Value Model"   },
  navGoldStructure:        { th: "Gold Price Structure",    en: "Gold Price Structure"    },
  navGoldBonds:            { th: "Gold vs Bonds",           en: "Gold vs Bonds"           },
  navFearIndex:            { th: "Fear Index",              en: "Fear Index"              },
  navMomentumComposite:    { th: "Momentum Composite",      en: "Momentum Composite"      },
  navGoldVolatility:       { th: "Gold Volatility",         en: "Gold Volatility"         },
  navRelativeStrength:     { th: "Relative Strength",       en: "Relative Strength"       },
  navEtfPositioning:       { th: "ETF Positioning",         en: "ETF Positioning"         },
  navRiskParity:           { th: "Risk Parity Model",       en: "Risk Parity Model"       },
  navMacroDashboard:       { th: "Macro Dashboard",         en: "Macro Dashboard"         },
  navGoldCycleClock:       { th: "Gold Cycle Clock",        en: "Gold Cycle Clock"        },
  navFuturesCurve:         { th: "Futures Term Structure",  en: "Futures Term Structure"  },
  navCotExtremes:          { th: "COT Positioning",         en: "COT Positioning"         },
  navHurstAnalysis:        { th: "Hurst Exponent",          en: "Hurst Exponent"          },
  ...
  navAsiaPremium:          { th: "Asia Gold Premium",       en: "Asia Gold Premium"       },
  navMacroDrivers:         { th: "Macro Driver Attribution", en: "Macro Drivers"          },
  navOptionsGamma:         { th: "Options Gamma Exposure",  en: "Options Gamma"           },
  navEventStudy:           { th: "Gold Event Study",         en: "Gold Event Study"        },
  navVixRegime:            { th: "VIX Regime Playbook",      en: "VIX Regime Playbook"     },
  navGoldBreakeven:        { th: "Gold vs Breakeven",        en: "Gold vs Breakeven"       },
  navGoldOwnership:        { th: "Gold Ownership",           en: "Gold Ownership"          },
  navCurrencyStress:       { th: "EM Currency Stress",       en: "EM Currency Stress"      },
  navFedDotPlot:           { th: "Fed Dot Plot",             en: "Fed Dot Plot"            },
  navComexVault:           { th: "COMEX Vault Inventory",    en: "COMEX Vault Inventory"   },
  navYieldSpread:          { th: "Yield Curve Spread",       en: "Yield Curve Spread"      },
  navGoldLeverage:         { th: "Gold Leverage Ratio",      en: "Gold Leverage Ratio"     },
  navGlobalGoldPrice:      { th: "Gold in Currencies",      en: "Gold in Currencies"      },
  navProducerCost:         { th: "Producer Cost Curve",     en: "Producer Cost Curve"     },
  navTradeSetup:           { th: "Trade Setup Scanner",     en: "Trade Setup Scanner"     },
  navGoldCycleAnalysis:    { th: "Gold Cycle Analysis",    en: "Gold Cycle Analysis"     },
  navMacroRegime:          { th: "Macro Regime Matrix",    en: "Macro Regime Matrix"     },
  navSupplyShock:          { th: "Supply Shock Monitor",   en: "Supply Shock Monitor"    },
  navDollarMilkshake:      { th: "Dollar Milkshake Theory", en: "Dollar Milkshake Theory" },
  navCotLive:              { th: "COT Live Positioning",    en: "COT Live Positioning"    },
  navGoldNewsCatalyst:     { th: "Gold News Catalysts",     en: "Gold News Catalysts"     },
